...
interface IUniDeviceConnection {
     ...
     */
    void unregisterCallback(IUniDeviceConnectionCallback uniConnectionCallback);
     ...
     */
    int registerVirtualCamera(String cameraId, boolean registerAsRearCamera);

    /**
     * 反注册虚拟摄像头
     * @param cameraId 泛设备摄像头id
     */
    int unregisterVirtualCamera(String cameraId, boolean unregisterRearCamera);
}
